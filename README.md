...
- Termux (recommended for advanced features)

## Installation

1. Download `Gradle_Build_Tool.apk`
2. Install the APK.
3. Open the application.
4. Configure your development environment.
5. Open or create a Gradle project and start building.
...
- 💻 ترمینال داخلی
- 📱 پشتیبانی از Termux
- 🛠 تنظیم SDK و محیط توسعه
- 📚 دانلود و مدیریت وابستگی‌ها
- 🌙 رابط کاربری مدرن با حالت تیره
- ⚡ سریع، سبک و بهینه

## پیش‌نیازها

- اندروید 7.0 یا بالاتر
- حداقل 2 گیگابایت رم (پیشنهاد می‌شود)
- اتصال اینترنت برای دانلود وابستگی‌ها
- نصب Termux برای امکانات پیشرفته
